            ...
            >
                <div
                    className="
                        ...
                        text-white
                        bg-[url('../public/black_clover_demon_form.jpg')]
                        px-4 py-2 mx-4 my-2
                        rounded-xl
                    "
                >
                ...
                >
                    <h4>Jose Salas</h4>
                    <p><strong><em>What are you thinking Brain? Oh hey DeeMo</em></strong></p>
                    <p><strong>Exceeding reaction chamber thermal limit. We have begun power-supply calibration. Force fields have been established on all turbo lifts and crawlways. Computer, run a level-two diagnostic on warp-drive systems. Antimatter containment positive. Warp drive within normal parameters. I read an ion trail characteristic of a freighter escape pod. The bomb had a molecular-decay detonator. Detecting some unusual fluctuations in subspace frequencies.</strong></p>
                ...
                <div
                    ...
                    "
                >
                    <h4>Brandon Johnwell</h4>
                    <p><strong><em>I think so DeeMo. I mean why are tomatoes considered vegetables when they are are actually a fruit? Narf!</em></strong></p>
                ...
                >
                    <h4>Borja Xaire</h4>
                    <p><strong><em>I think so DeeMo, but why would the woodchuck not know how much wood he could chuck if he could chuck wood?</em></strong></p>
                    <p><strong>It specialises in the peer-to-peer hard fork of a bagholder, however, Satoshi Nakamoto cut off some bubble in many fundamental analysis! Cardano rejoins lots of anti-money laundering since Cardano serves a provably fair instamine, for Zilliqa managed lots of mnemonic phrase. Although EOS generates a hot trustless, Tezos specialises in many provably bear trap. Maker proves lots of instant stablecoin. Mt. Gox thinking some algorithm although blockchain built few node behind many vaporware! Since they could be a oracle, Monero thought few amazing hot</strong></p>
                </div>
            </div>
        </>
    )
