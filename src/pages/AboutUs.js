const AboutUs  = () => {
    ...
    return(
        <> 
            <div className='max-h-full bg-gradient-to-b pt-1 pb-20 from-gray-950 via-gray-800 to-gray-800 text-white'>

                <div className="container flex justify-center mx-auto pt-16">
                    <div>
                        {/* <p className="text-gray-500 text-lg text-center font-normal pb-3">BUILDING TEAM</p> */}
                        <h1 className="xl:text-4xl text-3xl text-center text-red-400 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Cast of Characters</h1>
                    </div>
                </div>
                ...
                <div className="w-full px-10">
                    <div className="container mx-auto">
                        ...
                        <div className="lg:flex md:flex xl:justify-between flex-col md:justify-around sm:justify-around lg:justify-around pt-1">
                            ...
                            <div className="xl:w-1/3 sm:w-1/2 mx-auto sm:max-w-xs mb-20 xl:max-w-sm lg:w-1/2 pt-2 pb-2">
                                <div className="bg-top bg-cover bg-no-repeat h-64">
